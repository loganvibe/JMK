-- ============================================================
-- Safe AI tables setup with admin-panel-friendly RLS
...
DROP POLICY IF EXISTS "Allow all manage ai_providers" ON public.ai_providers;
...
DROP POLICY IF EXISTS "Allow all manage ai_models" ON public.ai_models;
...
DROP POLICY IF EXISTS "Allow all manage ai_feature_settings" ON public.ai_feature_settings;
...
DROP POLICY IF EXISTS "Allow all manage ai_provider_pricing" ON public.ai_provider_pricing;
...
DROP POLICY IF EXISTS "Allow all manage ai_provider_budgets" ON public.ai_provider_budgets;
...
DROP POLICY IF EXISTS "Allow all manage ai_provider_usage" ON public.ai_provider_usage;
...
DROP POLICY IF EXISTS "Allow all manage ai_credit_balances" ON public.ai_credit_balances;
...
DROP POLICY IF EXISTS "Allow all manage ai_credit_usage" ON public.ai_credit_usage;
...
INSERT INTO public.ai_models (provider_id, model_id, label, tier, input_price_per_1k, output_price_per_1k, sort_order)
SELECT p.id, 'z-ai/glm-5.2:free', 'GLM-5.2 Free', 'standard', 0, 0, 4 FROM public.ai_providers p WHERE p.vendor = 'openrouter' ON CONFLICT (provider_id, model_id) DO NOTHING;
INSERT INTO public.ai_models (provider_id, model_id, label, tier, input_price_per_1k, output_price_per_1k, sort_order)
SELECT p.id, 'stealth/ox-alpha', 'Stealth OX Alpha', 'standard', 0, 0, 5 FROM public.ai_providers p WHERE p.vendor = 'openrouter' ON CONFLICT (provider_id, model_id) DO NOTHING;
INSERT INTO public.ai_models (provider_id, model_id, label, tier, input_price_per_1k, output_price_per_1k, sort_order)
SELECT p.id, 'llama-3.3-70b-versatile', 'Llama 3.3 70B Versatile', 'standard', 0, 0, 1 FROM public.ai_providers p WHERE p.vendor = 'groq' ON CONFLICT (provider_id, model_id) DO NOTHING;
INSERT INTO public.ai_models (provider_id, model_id, label, tier, input_price_per_1k, output_price_per_1k, sort_order)
SELECT p.id, 'llama-3.1-8b-instant', 'Llama 3.1 8B Instant', 'standard', 0, 0, 2 FROM public.ai_providers p WHERE p.vendor = 'groq' ON CONFLICT (provider_id, model_id) DO NOTHING;
